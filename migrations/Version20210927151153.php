 ...
 */
final class Version20210927151153 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Add Video entity';
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE figure ADD videos LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:array)\'');
    }
}
